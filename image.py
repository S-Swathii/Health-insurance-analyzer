...
class HealthInsuranceAnalysisApp:
    def __init__(self):
        ...
        self.video_source = "/Users/i.seviantojensima/Desktop/Jensi/Sem 4/pa/pa.mp4"  # Path to your video file
    ...
    '''def open_regression_options(self):
        ...
        background_image_path = "/Users/i.seviantojensima/Desktop/Jensi/Sem 4/pa/pexels-alesiakozik-6770611.jpg"
        print("Background image path:", background_image_path)  # Print the image path
        try:
        ...
        background_label = tk.Label(regression_window, image=background_photo)
    ...
    def open_regression_options(self):
        ...
        try:
            background_image = Image.open(background_image_path)
            self.background_photo_regression = ImageTk.PhotoImage(background_image)  # Store as instance variable
        except Exception as e:
            print("Error loading image:", e)
            return

        # Create a label to display the background image
        background_label = tk.Label(regression_window, image=self.background_photo_regression)
        background_label.place(x=0, y=0, relwidth=1, relheight=1)
...
def open_test_options(self):
    ...
    # Load the background image
    background_image_path = "/Users/i.seviantojensima/Desktop/Jensi/Sem 4/pa/pexels-danny-meneses-340146-943096.jpg"
    try:
        background_image = Image.open(background_image_path)
        self.background_photo_test = ImageTk.PhotoImage(background_image)  # Store as instance variable
    except Exception as e:
        print("Error loading image:", e)
        return

    # Create a label to display the background image
    background_label = tk.Label(test_window, image=self.background_photo_test)
    background_label.place(x=0, y=0, relwidth=1, relheight=1)
    ...
    '''def open_test_options(self):
        ...
        # Create a label to display the background image
        background_label = tk.Label(test_window, image=background_photo)
        background_label.place(x=0, y=0, relwidth=1, relheight=1)
