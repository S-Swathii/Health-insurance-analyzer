...
class HealthInsuranceAnalysisApp:
    ...
    def open_regression_options(self):
        ...
        regression_image_path = "regression f.jpg"  
        regression_image = Image.open(regression_image_path)
        regression_image = regression_image.resize((self.root.winfo_screenwidth(), self.root.winfo_screenheight()))  # Resize image to fit the window
        ...
        regression_image_label.place(relx=0.5, rely=0.5, anchor=tk.CENTER)  # Center the image
        ...
        linear_regression_button = tk.Button(regression_window, text="Linear Regression", command=self.linear_regression_clicked)
    ...
    def open_test_options(self):
        ...
        # Load and display image as background
        test_image_path = "test.jpg"  # Change to your image path
        test_image = Image.open(test_image_path)
        test_image = test_image.resize((self.root.winfo_screenwidth(), self.root.winfo_screenheight()))  # Resize image to fit the window
        ...
        test_image_label.place(relx=0.5, rely=0.5, anchor=tk.CENTER)  # Center the image

        # Add buttons for test options
        anova_button = tk.Button(test_window, text="Perform ANOVA", command=self.anova_clicked)
        anova_button.place(relx=0.5, rely=0.5, anchor=tk.CENTER)

        ttest_button = tk.Button(test_window, text="Perform T-test", command=self.ttest_clicked)
        ttest_button.place(relx=0.5, rely=0.6, anchor=tk.CENTER)

        ftest_button = tk.Button(test_window, text="Perform F-test", command=self.ftest_clicked)
        ftest_button.place(relx=0.5, rely=0.7, anchor=tk.CENTER)
